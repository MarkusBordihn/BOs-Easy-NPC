...
- Fixed oversized names, lists and NPC data in network packets being read without any limit.
...
- Changed Skeleton, Stray and Bogged NPCs to the vanilla hitbox height, they were slightly short.
...
- Fixed selection box drop-down lists being covered by the checkboxes and labels behind them.
...
- Changed the minimum Easy Model Entities version to 2.2.0, older versions are no longer accepted.
...
- Added new gametest strcuture to support gametest in 1.21.11 and higher.
